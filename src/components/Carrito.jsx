    ...
    const mostrarProductos = (productosCarrito) => {
        ...
        return (
            <div className='contenedor-productos'>
                <img className='img-carrito' src={imgProducto1} alt='icono carrito' />
                <div className='datos-productos'> 
                    <p className='producto-en-carrito'>{productosCarrito[0]?.name}</p>
                    <span className='precio'>${precio}.00 x {productosCarrito.length} =</span> 
                    <span className='total-precio'>${total}.00 </span>
                    <button className='delete' onClick={()=>dispatch(eliminarDelCarrito     (productosCarrito))}> <img src={delete1} alt="" />
                    </button>
            ...
            return (
                <div className='carrito-vacio'><p>Your cart is empty.</p>
                </div>
            )
        }
    }
